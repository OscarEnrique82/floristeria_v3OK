...
<div id="toppanel">
	<div id="panel">
		<div class="content clearfix">
			<div class="left">
				<h1>Bienvendio a MontseFloristeria</h1>
				<h2>Tienda especializada en arreglos florales</h2>		
				<p class="grey">Gracias por visitarnos, si aun no es miembro puede registrarse aqui. Si ya es miembro puede entrar con sus datos correspondientes!</p>
			</div>
...
<div id="total">
   	...
   	<div id="contenido">
        ...
        <li><img src="img/naviseparator.gif" alt="" width="40" height="13" /></li>
         ...
         <li><img src="img/naviseparator.gif" alt="" width="40" height="13" /></li>
          <li><a href="categorias.php" class="main">Tienda</a></li>
...
<br>
    ...
    <div id="pie">
    <p>Copyright 2013 - MontseFloristeria | Hecho por SPC especialistas en desarrollo de app para moviles</p>
    </div>
    </div>
</body>
</html>
