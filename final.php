...
$pedido ="Pedido de productos MontseFloristeria. <br><br>";
$total=0;
...
$asunto="Pedido Tienda MontseFloristeria";
...
$mail->AddAddress("pavillalta@gmail.com","Copia de Pedido ");
$mail->Body = $pedido;
...
<html>
<body>
<h1>Usted est&aacute; siendo redirigido a la plataforma de pago paypal... espere un momento</h1>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" name="pago" id="pago">
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="pavillalta@gmail.com">
<input type="hidden" name="item_name" value="MontseFloristeria">
